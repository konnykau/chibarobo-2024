...
#include "robomas_plugins/msg/detail/frame__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const robomas_plugins::msg::Frame *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robomas_plugins::msg::Frame *>(
    untyped_ros_message);
...
{
  return &robomas_plugins::msg::typesupport_fastrtps_cpp::_Frame__handle;
}
