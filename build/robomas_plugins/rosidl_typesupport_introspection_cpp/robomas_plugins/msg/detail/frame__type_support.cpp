...
{
  new (message_memory) robomas_plugins::msg::Frame(_init);
}

void Frame_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robomas_plugins::msg::Frame *>(message_memory);
  typed_message->~Frame();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Frame_message_member_array[7] = {
  {
    ...
    offsetof(robomas_plugins::msg::Frame, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, is_rtr),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, is_extended),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, is_error),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, dlc),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    8,  // array size
    false,  // is upper bound
    offsetof(robomas_plugins::msg::Frame, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Frame_message_members = {
  ...
  "Frame",  // message name
  7,  // number of fields
  sizeof(robomas_plugins::msg::Frame),
...
get_message_type_support_handle<robomas_plugins::msg::Frame>()
{
  return &::robomas_plugins::msg::rosidl_typesupport_introspection_cpp::Frame_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robomas_plugins, msg, Frame)() {
  return &::robomas_plugins::msg::rosidl_typesupport_introspection_cpp::Frame_message_type_support_handle;
}
