...
#include "robomas_plugins/msg/detail/frame__rosidl_typesupport_fastrtps_c.h"
...
using _Frame__ros_msg_type = robomas_plugins__msg__Frame;
...
size_t get_serialized_size_robomas_plugins__msg__Frame(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Frame__ros_msg_type * ros_message = static_cast<const _Frame__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Frame__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robomas_plugins__msg__Frame(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_robomas_plugins
size_t max_serialized_size_robomas_plugins__msg__Frame(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _Frame__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robomas_plugins__msg__Frame(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robomas_plugins, msg, Frame)() {
