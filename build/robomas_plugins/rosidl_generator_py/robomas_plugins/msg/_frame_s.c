...
bool robomas_plugins__msg__frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robomas_plugins.msg._frame.Frame", full_classname_dest, 32) == 0);
  }
  robomas_plugins__msg__Frame * ros_message = _ros_message;
  {  // header
...
PyObject * robomas_plugins__msg__frame__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robomas_plugins.msg._frame");
