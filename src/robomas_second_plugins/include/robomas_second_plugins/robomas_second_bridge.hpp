...
#include "robomas_second_plugins/cobs.hpp"
#include "robomas_second_plugins/test.hpp"
...
namespace robomas_bridge
{
    ...
    class RobomasSecondBridge : public rclcpp::Node
    {
    private:
        /////////////Slacan Status///////////////////
        ...
        std::string port_name_ = "/dev/robomas_second";
    ...
    public:
        RobomasSecondBridge(const rclcpp::NodeOptions &options);
